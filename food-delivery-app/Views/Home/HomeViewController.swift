...
class HomeViewController: UIViewController {
    ...
    var categories: [DishCategory] = [
        .init(id: "id1", name: "Dish 1", image: "https://picsum.photos/100/200"),
        .init(id: "id1", name: "Dish 2", image: "https://picsum.photos/100/200"),
        .init(id: "id1", name: "Dish 3", image: "https://picsum.photos/100/200"),
        .init(id: "id1", name: "Dish 4", image: "https://picsum.photos/100/200"),
        .init(id: "id1", name: "Dish 5", image: "https://picsum.photos/100/200")
    ]
